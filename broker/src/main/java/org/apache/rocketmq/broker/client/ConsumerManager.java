...
public class ConsumerManager {
	...
	public ClientChannelInfo findChannel(final String group, final String clientId) {
		...
		if (consumerGroupInfo != null) { return consumerGroupInfo.findChannel(clientId); }
		return null;
	}

	public ClientChannelInfo findChannel(final String group, final Channel channel) {
		ConsumerGroupInfo consumerGroupInfo = this.consumerTable.get(group);
		if (consumerGroupInfo != null) { return consumerGroupInfo.findChannel(channel); }
		return null;
	}
	...
	public SubscriptionData findSubscriptionData(final String group, final String topic, boolean fromCompensationTable) {
		...
		if (consumerGroupInfo != null) {
			...
			if (subscriptionData != null) { return subscriptionData; }
		}

		if (fromCompensationTable) {
			ConsumerGroupInfo consumerGroupCompensationInfo = consumerCompensationTable.get(group);
			if (consumerGroupCompensationInfo != null) { return consumerGroupCompensationInfo.findSubscriptionData(topic); }
		}
		return null;
	}
	...
	public int findSubscriptionDataCount(final String group) {
		...
		if (consumerGroupInfo != null) { return consumerGroupInfo.getSubscriptionTable().size(); }
